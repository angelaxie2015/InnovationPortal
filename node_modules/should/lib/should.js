...
should.AssertionError = require('should/lib/assertion-error');
should.Assertion = require('should/lib/assertion');

should.format = util.format;
should.type = require('should/lib/node_modules/should-type');
should.util = util;
 ...
 */
should.config = require('should/lib/config');
